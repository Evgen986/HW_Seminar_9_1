...
def import_base(message):
    ...
    src = 'C:/Users/Evgen/Documents/ОБУЧЕНИЕ/Python/GB/Seminars/Seminar_9/Home_work/phonebook/files' + \
...
def export_file(message):
    if message.text == '1':
        ...
        bot.send_document(chat_id, open(r'C:/Users/Evgen/Documents/ОБУЧЕНИЕ/Python/GB/Seminars/Seminar_9/Home_work'
                                        r'/phonebook/export.csv', 'rb'))
    elif message.text == '2':
        lg.write_data(f'Запущен экспорт по второму правилу')
        wd.ex_base(message.text)
        bot.send_document(chat_id, open(r'C:/Users/Evgen/Documents/ОБУЧЕНИЕ/Python/GB/Seminars/Seminar_9/Home_work'
                                        r'/phonebook/export_2.csv', 'rb'))
    else:
